...
public final class ConfigImpl extends YamlConfiguration implements Config {
     ...
     * @return A new instance of ConfigImpl contains all the data (keys, values and comments).
     */
    public static ConfigImpl loadConfiguration(File file) {
        try {
            ...
            return new ConfigImpl().flagAsFailed();
        }
    }
     ...
     * @return A new instance of ConfigImpl contains all the data (keys, values and comments).
     */
    public static ConfigImpl loadConfiguration(InputStream inputStream) {
     ...
     * @return A new instance of ConfigImpl contains all the data (keys, values and comments).
     */
    public static ConfigImpl loadConfiguration(Reader reader) {
     ...
     */
    private static String getSectionPath(ConfigImpl commentedConfig, String line, String currentSection) {
    ...
    public void syncWithConfig(File file, InputStream resource, String... ignoredSections) throws IOException {
        ...
        ConfigImpl cfg = loadConfiguration(resource);
     ...
     */
    private boolean syncConfigurationSection(ConfigImpl commentedConfig, ConfigurationSection section, List<String> ignoredSections) {
        //Variables that are used to track progress.
     ...
     */
    private ConfigImpl flagAsFailed() {
